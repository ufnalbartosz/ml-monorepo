...
from project_cnn.cache import cache
...
def one_hot_encoded(class_numbers, num_classes=None):
    ...
    # The class-numbers are zero-based, so the highest class-number
    # plus one is the number of classes.
...
class DataSet:
    def __init__(self, in_dir, exts='.jpg'):
        ...
        # Wrap a single extension in a tuple, otherwise iterating over it
        # would split the string into single characters, e.g. '.jpg' would
        # become ('.', 'j', 'p', 'g') and match almost any filename.
